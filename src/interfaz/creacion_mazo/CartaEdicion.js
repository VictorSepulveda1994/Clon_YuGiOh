 ...
 class CartaEdicion{
    constructor(scene){
        this.render = (x,y,sprite) =>{
            var carta = scene.add.image(x,y,sprite).setScale(0.5,0.5).setInteractive();
            scene.input.setDraggable(carta);
            /**
             * Funcion para el manejo de arnes para el manejo del arrastre
             * -dragstart inicializa el arrastre cambiando elrastre de una carta
             * dragstart, drag, dragend son las funcio colo de la carta
